// 1. Домашнее задание
// Используя массив объектов пользователей users (дальше в задании), напиши функции которые
//  с помощью перебирающих методов массивов (никаких for, splice и т. д.) выполняют следующие операции.
const users = [
  {
